...
Future<Map<String, dynamic>> rejectLeads() async {
  const String apiUrl =
      'https://clms-lenovo1.hashconnect.in/api/lead/common/leadList?start=0&size=10&statusIn=5';
  ...
  if (response.statusCode == 200) {
    ...
    throw Exception('Failed to load reject leads data');
  }
}
