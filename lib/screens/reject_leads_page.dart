...
import 'package:lenovo_app/services/reject_leads.dart';
import 'package:url_launcher/url_launcher.dart';

class RejectLeadsPage extends StatefulWidget {
  const RejectLeadsPage({Key? key, required Map<String, dynamic> data})
      : super(key: key);

  @override
  _RejectLeadsPageState createState() => _RejectLeadsPageState();
}

class _RejectLeadsPageState extends State<RejectLeadsPage> {
  String editText = '';
  ...
  void initState() {
    super.initState();
    fetchRejectLeads(); // Change the function call here
  }

  void fetchRejectLeads() async {
    try {
      final Map<String, dynamic> data = await rejectLeads();
      log('Reject leads data: $data');
      setState(() {
        records = data['records'] ?? [];
      });
    } catch (error) {
      print('Error fetching reject leads data: $error');
    }
  }
